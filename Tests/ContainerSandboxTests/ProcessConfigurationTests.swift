...
/// Tests for AgentTemplate.processConfiguration — the env-layering and
/// argument-assembly helper that turns a base container config into the
/// launch config for an agent's entrypoint.
